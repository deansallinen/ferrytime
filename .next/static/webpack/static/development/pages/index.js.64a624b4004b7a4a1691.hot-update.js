...
var _jsxFileName = "/home/deza604/ferry-tracker2/components/appBar.js";
...
function (_React$Component) {
  ...
  _createClass(Header, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                request(URL, query).then(function (data) {
                  return _this2.setState({
                    data: data
                  });
                }); // console.log(`All routes fetched. Count: ${this.state.data.allRoutes.length}`);
    ...
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_appBar__WEBPACK_IMPORTED_MODULE_2__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 21
        },
  ...
  _createClass(FerryMenu, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = "{\n        allRoutes {\n          id\n          routeName\n        }\n      }";
                URL = 'https://ferrytrackerserver.now.sh/graphql';
                Object(graphql_request__WEBPACK_IMPORTED_MODULE_6__["request"])(URL, query).then(function (data) {
                  return _this2.setState({
                    data: data
                  });
                }); // console.log(`All routes fetched. Count: ${this.state.data.allRoutes.length}`);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_material_ui_core_List__WEBPACK_IMPORTED_MODULE_3___default.a, {
        ...
        __self: this
      }, this.state.data.allRoutes.map(function (route) {
...
/*!*****************************************************************************************************!*\
  !*** delegated ./node_modules/fbjs/lib/shallowEqual.js from dll-reference dll_d11dbd366126b73f03b1 ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = (__webpack_require__(/*! dll-reference dll_d11dbd366126b73f03b1 */ "dll-reference dll_d11dbd366126b73f03b1"))("./node_modules/fbjs/lib/shallowEqual.js");
...
//# sourceMappingURL=index.js.64a624b4004b7a4a1691.hot-update.js.map