          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                }).then(console.log(this.state.data)); // console.log(`All routes fetched. Count: ${this.state.data.allRoutes.length}`);
...
//# sourceMappingURL=index.js.e393726018a5249f504d.hot-update.js.map