...
var Index = function Index(props) {
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
  ...
  }, props.res.allRoutes.map(function (show) {
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("li", {
      ...
      as: "/p/".concat(show.routeName),
      href: "/post?id=".concat(show.routeName),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 11
      }
  ...
  return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          console.log("Show data fetched. Count: ".concat(JSON.stringify(res)));
...
//# sourceMappingURL=4.8a8793ce4821228cad84.hot-update.js.map