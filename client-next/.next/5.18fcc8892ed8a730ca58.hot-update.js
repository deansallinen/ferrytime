...
var formatSailingTime = function formatSailingTime(time) {
  return time ? Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["format"])(Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["parse"])(Number(time)), 'YY-MM-DD HH:ss') : time;
};
...
var Post = function Post(props) {
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
    ...
    }, sailing.vessel, " - ", formatSailingTime(sailing.scheduledDeparture), " -", ' ', formatSailingTime(sailing.actualDeparture), " -", ' ', formatSailingTime(sailing.eta), " - ", sailing.sailingStatus);
  })));
};
...
//# sourceMappingURL=5.18fcc8892ed8a730ca58.hot-update.js.map