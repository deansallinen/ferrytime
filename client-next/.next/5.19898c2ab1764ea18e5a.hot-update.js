...
var Post = function Post(props) {
  ...
  }, "test", __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h1", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            routeName = context.query.id.routeName;
            gqlq = "{\n      route(routeName: ".concat(routeName, "){\n          sailings {\n              vessel\n          }\n      }\n  }");
            _context.next = 5;
            return Object(__WEBPACK_IMPORTED_MODULE_3_graphql_request__["request"])('https://server-dubymzzcjd.now.sh/graphql', gqlq);

          case 5:
            res = _context.sent;
            console.log("Route info fetched. Sailings: ".concat(res.sailings.length));
...
//# sourceMappingURL=5.19898c2ab1764ea18e5a.hot-update.js.map