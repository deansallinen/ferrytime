...
var formatSailingTime = function formatSailingTime(time) {
  return time ? Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["format"])(new Date(time).getTime(), 'HH:mm Z') : time;
};
...
//# sourceMappingURL=5.411ac65fe4db88bcc11b.hot-update.js.map