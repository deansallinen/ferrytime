...
var URL = 'https://server-vuuxbovyix.now.sh/graphql'; // const URL = 'http://localhost:4000/graphql';

var formatSailingTime = function formatSailingTime(time) {
  return time ? Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["format"])(new Date(time).getTime(), 'YY-MM-DD HH:mm Z') : time;
};
...
var Post = function Post(props) {
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
    ...
    }, sailing.vessel, " - ", formatSailingTime(sailing.scheduledDeparture), " -", ' ', sailing.sailingStatus, sailing.lastUpdated);
  })));
};
...
//# sourceMappingURL=5.d7258c6f5e325c446ffa.hot-update.js.map