...
var URL = 'https://server-afiwemkccs.now.sh/graphql'; // const URL = 'http://localhost:4000/graphql';

var formatSailingTime = function formatSailingTime(time) {
  return time ? Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["format"])(Number(time), 'YY-MM-DD HH:mm Z') : time;
};
...
//# sourceMappingURL=5.dade69af920b50b70adb.hot-update.js.map