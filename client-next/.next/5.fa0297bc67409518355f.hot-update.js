...
var formatSailingTime = function formatSailingTime(time) {
  Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["format"])(Number(sailing.scheduledDeparture), 'DD-MM-YY HH:ss');
};
...
var Post = function Post(props) {
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
    ...
    }, sailing.vessel, " -", ' ', Object(__WEBPACK_IMPORTED_MODULE_4_date_fns__["format"])(Number(sailing.scheduledDeparture), 'DD-MM-YY HH:ss'), " -", ' ', sailing.actualDeparture, " - ", sailing.eta, " - ", sailing.sailingStatus);
  })));
};
...
//# sourceMappingURL=5.fa0297bc67409518355f.hot-update.js.map