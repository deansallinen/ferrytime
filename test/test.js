...
describe("API", function() {
  ...
  it("should list all a routes sailings for a date on /routes/<id>/sailings/<date> GET");
  it("should create a single sailing on /routes/<id>/sailings/<date> POST");
  it("should update or create a single sailing on /routes/<id>/sailings/<date> PUT");
})
